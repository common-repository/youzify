...
class Youzify {
    ...
    function buddypress_init() {
        ...
        if ( defined( 'LLMS_PLUGIN_FILE' ) ) {
            require YOUZIFY_CORE . 'class-youzify-lifter-integration.php';
        }

        // LearnPress Integration
        if ( defined( 'LP_PLUGIN_FILE' ) ) {
            require YOUZIFY_CORE . 'class-youzify-learnpress-integration.php';
        }
        ...
        // if ( is_buddypress() || $doing_ajax ) {
           ...
           include YOUZIFY_CORE . 'class-youzify-user.php';
            ...
            if ( youzify_option( 'youzify_lazy_load', 'on' ) == 'on' && ! is_admin() ) {
