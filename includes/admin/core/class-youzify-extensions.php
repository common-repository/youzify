			...
			<?php foreach ( $extensions['products'] as $extension ) :  if ( $extension['info']['id'] == '102475' ) {
				...
				<div class="youzify-ext-item">
					<div class="youzify-ext-container">
						<a class="youzify-ext-thumb" href="<?php echo esc_url( $extension['info']['link'] ); ?>" style="background-image: url(<?php echo $extension['info']['thumbnail']; ?>);">
						...
						<div class="youzify-ext-content">
							<div class="youzify-ext-title"><a href="<?php echo esc_url( $extension['info']['link'] ); ?>"><?php echo $extension['info']['title']; ?></a></div>
