...
function youzify_get_user_statistics_options() {
    ...
    $statistics = array(
        'posts'     => __( 'Blog Posts', 'youzify' ),
        'comments'  => __( 'Blog Comments', 'youzify' ),
        'activity_posts' => __( 'Activity Posts', 'youzify' ),
        'activity_comments' => __( 'Activity Comments', 'youzify' ),
    ...
    // $statistics['forum_posts'] = __( 'Forum Posts', 'youzify' );
    // $statistics['forum_comments'] = __( 'Forum Comments', 'youzify' );
        ...
        <div class="yzp-table">
            ...
            <div class="yzp-box yzp-<?php echo $box['theme'] ?>-theme yzp-<?php echo $key; ?>-box">
                ...
                <div class="yzp-box-footer">
                    <a target="_blank"class="yzp-cta-button" href="<?php echo esc_url( $box['link'] ); ?>"><?php echo $box['cta']; ?><i class="far fa-arrow-alt-circle-right"></i></a>
                </div>
