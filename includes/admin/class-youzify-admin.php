                ...
                <div style="margin-left:30px">
                    ...
                    <div class="youzify-buttons-row">
                        <a class="button button-primary" target="_blank"
                           href="<?php echo esc_url( apply_filters( 'youzify_plugin_post_new_review_link', 'https://wordpress.org/support/plugin/youzify/reviews/#new-post' ) ); ?>"><?php _e( 'Yes, you deserve it', 'youzify' ); ?></a>
	            ...
	            <div class="youzify-log-message">
	                ...
	                <div class="youzify-log-offers">
	                    <!-- <div class="youzify-log-offer">
	                        ...
	                        <div class="youzify-offer-img"><a href="<?php echo esc_url( $offer['link'] ); ?>"><img src="<?php echo $offer['image']; ?>" alt=""></a></div>
	                        <div class="youzify-offer-details">
	                            <div class="youzify-offer-title"><a href="<?php echo esc_url( $offer['link'] ); ?>"><?php echo $offer['title']; ?></a></div>
	                            ...
	                            <div class="youzify-offer-button"><a target="_blank" href="<?php echo esc_url( $offer['link'] ); ?>"><span class="yz-shake-me">👉</span><?php echo $offer['button']; ?></a></div>
	                        </div>
	                    </div> -->
		                ...
		                <div class="youzify-offer-coupon">
		                	...
		                	<div class="youzify-coupon-button"><a href="<?php echo esc_url( $coupon['link'] ); ?>"><?php echo $coupon['button']; ?></div>
		                </div>
	                	<?php endif; ?>
