...
<div id="<?php echo apply_filters( 'youzify_activity_template_id', 'youzify-bp' ); ?>" class="youzify youzify-page noLightbox <?php echo youzify_get_activity_page_class(); ?>">
	...
	<div class="youzify-content">
						...
						<?php if ( is_user_logged_in() ) : ?>
							...
							<?php if ( bp_is_active( 'friends' ) ) : ?>
								...
								<?php if ( bp_get_total_friend_count( bp_loggedin_user_id() ) ) : ?>
									...
									<li id="activity-friends"><a href="<?php echo esc_url( bp_loggedin_user_domain() . bp_get_activity_slug() . '/' . bp_get_friends_slug() . '/' ); ?>"><?php printf( __( 'My Friends %s', 'youzify' ), '<span>' . bp_get_total_friend_count( bp_loggedin_user_id() ) . '</span>' ); ?></a></li>
							...
							<?php if ( bp_is_active( 'groups' ) ) : ?>
								...
								<?php if ( bp_get_total_group_count_for_user( bp_loggedin_user_id() ) ) : ?>
									...
									<li id="activity-groups"><a href="<?php echo esc_url( bp_loggedin_user_domain() . bp_get_activity_slug() . '/' . bp_get_groups_slug() . '/' ); ?>"><?php printf( __( 'My Groups %s', 'youzify' ), '<span>' . bp_get_total_group_count_for_user( bp_loggedin_user_id() ) . '</span>' ); ?></a></li>
							...
							<?php if ( bp_get_total_favorite_count_for_user( bp_loggedin_user_id() ) ) : ?>
								...
								<li id="activity-favorites"><a href="<?php echo esc_url( bp_loggedin_user_domain() . bp_get_activity_slug() . '/favorites/' ); ?>"><?php printf( __( 'My Favorites %s', 'youzify' ), '<span>' . bp_get_total_favorite_count_for_user( bp_loggedin_user_id() ) . '</span>' ); ?></a></li>
							...
							<?php if ( bp_activity_do_mentions() ) : ?>
								...
								<li id="activity-mentions"><a href="<?php echo esc_url( bp_loggedin_user_domain() . bp_get_activity_slug() . '/mentions/' ); ?>"><?php _e( 'Mentions', 'youzify' ); ?><?php if ( bp_get_total_mention_count_for_user( bp_loggedin_user_id() ) ) : ?> <strong><span><?php printf( _nx( '%s new', '%s new', bp_get_total_mention_count_for_user( bp_loggedin_user_id() ), 'Number of new activity mentions', 'youzify' ), bp_get_total_mention_count_for_user( bp_loggedin_user_id() ) ); ?></span></strong><?php endif; ?></a></li>
		...
		<?php do_action( 'youzify_after_activity_stream_tabs' ); ?>
