...
class Youzify_Tutor_Courses_Tab {
	...
	function tab() {
		...
		echo '<div class="youzify-tab youzify-courses"><div id="youzify-main-courses" class="youzify-tab youzify-tab-courses" data-plugin_type="tutor">';
	...
	function courses_core( $args, $user_id, $activity_type = '' ) {
		...
		foreach ( $blogs_ids as $b ) {
			...
			while ( $posts_query->have_posts() ) : $posts_query->the_post();
				...
				$course_progress =  tutor_utils()->get_course_completed_percent( $post_id, $user_id, true );
				...
				<div class="youzify-course-container">
					...
					<div class="youzify-course-inner-content">
						...
						<div class="youzify-course-head">
							<?php if ( $activity_type != 'new_tutor_course' && $display_enrolment_status == 'on' ) : ?>
							...
							<div class="youzify-course-meta">
								...
								<ul>
									<?php if ( $activity_type != 'new_tutor_course' && 'on' == $display_author ) : ?>
									<li>
						...
						<?php endif; ?>
							<?php if (  $activity_type != 'new_tutor_course' ) : ?>
