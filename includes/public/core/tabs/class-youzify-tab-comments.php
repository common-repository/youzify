				...
				<div class="youzify-comment-content">
					<div class="youzify-comment-head">
						...
						<div class="youzify-comment-meta">
							...
							<a href="<?php echo esc_url( $post_url ); ?>" class="youzify-comment-fullname"><?php echo get_the_title( $post_id ); ?></a>
							<?php endif; ?>
							<?php if ( 'on' == $display_button ) : ?>
								<a href="<?php echo esc_url( $comment_url ); ?>" class="view-comment-button">
