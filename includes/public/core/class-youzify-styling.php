   ...
   //  }
    ...
    function custom_scheme() {
        ...
        if ( 'on' != youzify_option( 'youzify_enable_profile_custom_scheme', 'off' ) ) {
            ...
            $scheme_colors = array(
                'youzify-aqua-scheme' => array( 'scheme' => '#1abc9c', 'text' => '#fff' ),
                'youzify-blue-scheme' => array( 'scheme' => '#4FC1E9', 'text' => '#fff' ),
                'youzify-brown-scheme' => array( 'scheme' => '#f5bb55', 'text' => '#fff' ),
                'youzify-crimson-scheme' => array( 'scheme' => '#f75d52', 'text' => '#fff' ),
                'youzify-darkblue-scheme' => array( 'scheme' => '#5798b7', 'text' => '#fff' ),
                'youzify-darkgray-scheme' => array( 'scheme' => '#868E96', 'text' => '#fff' ),
                'youzify-darkgreen-scheme' => array( 'scheme' => '#1FC36A', 'text' => '#fff' ),
                'youzify-darkorange-scheme' => array( 'scheme' => '#FF5534', 'text' => '#fff' ),
                'youzify-gray-scheme' => array( 'scheme' => '#9e9e9e', 'text' => '#fff' ),
                'youzify-green-scheme' => array( 'scheme' => '#53D86A', 'text' => '#fff' ),
                'youzify-lightblue-scheme' => array( 'scheme' => '#A1C3D3', 'text' => '#fff' ),
                'youzify-orange-scheme' => array( 'scheme' => '#FFC952', 'text' => '#fff' ),
                'youzify-pink-scheme' => array( 'scheme' => '#FF4966', 'text' => '#fff' ),
                'youzify-purple-scheme' => array( 'scheme' => '#9294f1', 'text' => '#fff' ),
                'youzify-red-scheme' => array( 'scheme' => '#eb1e32', 'text' => '#fff' ),
                'youzify-yellow-scheme' => array( 'scheme' => '#fff952', 'text' => '#757575' )
            );

            // Get Active Scheme
            $active_scheme = youzify_option( 'youzify_profile_scheme', 'youzify-blue-scheme' );

            if ( isset( $scheme_colors[ $active_scheme ] ) )  {
                $scheme_color = $scheme_colors[ $active_scheme ]['scheme'];
                $text_color = $scheme_colors[ $active_scheme ]['text'];
            }
        ...
        // Wether to force styling or Not.
        $important = apply_filters( 'youzify_force_styling', true ) ? '!important' : '';
...
body #youzify .youzify-directory-filter .item-list-tabs li#members-order-select label {
    ...
    color: var(--yzfy-scheme-text-color);
        ...
        body a.youzify-settings-widget {
            background: var(--yzfy-scheme-color) $pattern $important;
        }
    ";
