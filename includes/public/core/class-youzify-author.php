		...
		foreach ( $elements as $element ) :
			...
			if ( isset( $header_args[ $element ] ) ) :
				...
				if ( 'cover' == $element ) {
					...
					echo $cover;
					if ( bp_is_my_profile() && bp_displayed_user_use_cover_image_header() ) echo '<span class="youzify-open-upload-cover youzify-open-bp-uploader" data-type="cover" data-youzify-tooltip="' . __( 'Change Cover', 'youzify' ) . '"><i class="fas fa-camera"></i></span>';
