...
class Youzify_Header {
	...
	function get_header( $component ) {
		...
		<div class="youzify-header-cover">
			...
			<?php if ( bp_is_my_profile() && bp_displayed_user_use_cover_image_header() ) echo '<span class="youzify-open-upload-cover youzify-open-bp-uploader" data-type="cover"><i class="fas fa-camera"></i><span class="youzify-cover-uploader-label">' . __( 'Change Cover', 'youzify' ) . '</span></span>'; ?>
